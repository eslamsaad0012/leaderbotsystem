...
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~Team #Leaders-System~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~');
console.log(`Logged in as  * [ "  Team #Leaders-System" ] servers! [ " ${client.guilds.size} " ] Users! [ " ${client.users.size} " ]`); 
...
if(message.content == (prefix + "admin bot")) {
         if(!message.author.id === '464456235228332034') return;
var gimg;
var gname;
var gmemb;
var gbots;
  ...
  **
   ...
   **
   ...
   『soon』
             ...
             _ _---------------- _ _
  BOT By: | <@531716969045688321> |-| <@531716969045688321> |-| <@531716969045688321> |
...
client.on('message' , message => {
        ...
        client.channels.get("531716969045688321").send(
            "\n" + "**" + " ● Suggested By : " + "**" +
            "\n" + "**" + "» " + message.author.tag + "**" +
            "\n" + "**" + " ● Suggest : " + "**" +
            "\n" + "**" + args + "**")
...
client.on('message', message => {
    ...
    if (message.content === "Leaders-System") {
        setInterval(function(){
        message.edit('**L**')    
        message.edit('**LEAD**')    
        message.edit('**LEADERS**')
        message.edit('**Leaders-System**')
        }, 1000)
    }
...
if (message.content === (prefix + "support")) {
     message.author.send('https://discord.gg/PQrFptn').catch(e => console.log(e.stack));
    }
   } 
  });
  var prefix = "#"
...
if (message.author.id !== '531716969045688321','464456235228332034') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
if (message.author.id !== '531716969045688321','2464456235228332034') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult, "http://twitch.tv/y04zgamer");
    message.channel.sendMessage(`**${argresult}** :تم تغيير الحالة الى ستريمنج`)
} else

if (message.content.startsWith(prefix + 'name')) {
if (message.author.id !== '531716969045688321','294980175253209089') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
